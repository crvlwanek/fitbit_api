...
class API:
    ...
    def __request(self, http_method, url: str, params: dict = {}) -> dict:
        """
    ...
    def __delete(self, url: str, params = {}) -> dict:
        """
    ...
    def log_activity(self, activity_id: Union[str, int], id_type: str, manual_calories: int, start_time: str, duration_millis: int, date: str, distance: int) -> dict:
        """
    ...
    def activity_log_list(self, date: str, date_type: str, sort: str, limit: int, offset: int = 0) -> dict:
        ...
        Parameters:
          date: The date in the format yyyy-MM-ddTHH:mm:ss. Only yyyy-MM-dd is required. 
    ...
    def activity_tcx(self, log_id: str, include_partial_tcx: bool=True) -> dict:
        """
        ...
        return self.__get(f"/1/user/{self.user_id}/activities/{log_id}.tcx",
            params={"includePartialTCX": include_partial_tcx})
    ...
    def activity_type(self, activity_id: str) -> dict:
        """
    ...
    def delete_favorite_activity(self, activity_id: str):
        """
        ...
        """
        return self.__delete(f"/1/user/{self.user_id}/activities/favorite/{activity_id}.json")
    
    def add_favorite_activity(self, activity_id: str):
        """
    ...
    def update_activity_goals(self, period: str, type: str, value: str):
        """
    ...
    """
    def activity_intraday(self, resource_path: str, base_date: str, end_or_1d: str, detail_level: str, start_time: str = None, end_time: str = None):
        """
        ...
        Parameters:
          ...
          end_or_1d: Either an end date in the format yyyy-MM-dd or the string "1d" 
    ...
    def activity_time_series(self, resource_path: str, base_date: str, end_or_period: str, use_tracker: bool = False):
        ...
        Parameters:
          resource_path: calories, caloriesBMR, steps, distance, floors, elevation, minutesSedentary, 
            minutesLightlyActive, minutesFairlyActive, minutesVeryActive, or activityCalories
    ...
    def update_weight_goal(self, start_date: str, start_weight: str, weight: str):
        """
        Updates user's fat percentage goal.
